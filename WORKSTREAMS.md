...
| Detection | The other 53 ACT rules                                                                                                                                      | Nothing. One file each, and the [good first issue](https://github.com/KarthikSubramanian07/Marlo/issues?q=is%3Aissue+is%3Aopen+label%3Atype%3Anew-rule) list is sized for an afternoon. |
